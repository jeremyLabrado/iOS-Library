...
SWIFT_CLASS("_TtC19DemoMultipleChannel11AppDelegate")
...
@interface NSData (SWIFT_EXTENSION(DemoMultipleChannel))
...
/// 
/// </code>
SWIFT_CLASS("_TtC19DemoMultipleChannel15StretchSenseAPI")
...
SWIFT_CLASS("_TtC19DemoMultipleChannel14ViewController")
@interface ViewController : UIViewController <UIScrollViewDelegate, UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified myTableViewAvailable;
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified myTableViewConnected;
@property (nonatomic, strong) StretchSenseAPI * _Nonnull stretchsenseObject;

/// /////
- (void)viewDidLoad;
- (void)newInfoDetected;
- (void)newValueDetected0;
- (void)newValueDetected1;
- (void)newValueDetected2;
- (void)newValueDetected3;
- (void)newValueDetected4;
- (void)newValueDetected5;
- (void)newValueDetected6;
- (void)newValueDetected7;
- (void)newValueDetected8;
- (void)newValueDetected9;
...
@interface ViewController (SWIFT_EXTENSION(DemoMultipleChannel)) <MFMailComposeViewControllerDelegate>
